...
namespace Assets.CodeAssets.BattleEntities.Enemies.Summer
{
    ...
    /// <summary>
    ///  Summer is good at stress and long-term damage.  Unique Mechanics:
    ///  1)  Ritualist: increases doom counter in a way specific to the Summer Court (only affects summer court encounters).
